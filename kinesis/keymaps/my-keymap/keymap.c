...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [BASE] = LAYOUT(
    ...
    KC_ESCAPE,  KC_Z,       KC_X,       KC_C,       KC_V,       KC_B, 
                MY_KC_FN,   MY_KC_SYM2, MY_KC_SYM1, MY_KC_NUM,
    ...
    KC_LEFT,    KC_DOWN,    KC_RIGHT,   XXXXXXXXXX,
  ...
  [WINDOW_SWITCH] = LAYOUT(
    ...
    XXXXXXXXXX, XXXXXXXXXX, XXXXXXXXXX, XXXXXXXXXX, XXXXXXXXXX, XXXXXXXXXX,
                ...
                XXXXXXXXXX, XXXXXXXXXX,
                XXXXXXXXXX,
    MY_KC_WINDOW_SWITCH_SELECT, XXXXXXXXXX, XXXXXXXXXX,
    ...
    XXXXXXXXXX, XXXXXXXXXX,  
    XXXXXXXXXX,
    XXXXXXXXXX, MY_KC_WINDOW_SWITCH_CANCEL, XXXXXXXXXX
  ),
